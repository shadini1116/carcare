...
?> 
	...
	$result =  $mysqli->query("SELECT * FROM tbl_order ")or die ($mysqli->erorr);	
...
<li><div align="center"><a class="active" href="vieworders.php">Orders</a></div>	</li>
...
$result = $mysqli->query("SELECT *  FROM tbl_order WHERE order_id = '$search' LIMIT 1" ) ; 
}	 
?>					 						 
    <table align="center">
<form method="POST" class="form">
<th> <input type="text" name="search" class="form-control" width="100px"  placeholder="Enter Bill ID" >	  </th> 
<th><input type="submit" class="btn btn-primary" value="Search Bill" name="submit3" class="form-group"></th>
</form>
 	 </table>
<h1 class="jumbotron" align="center">Orders</h1>
<table class="table table-striped table-hover" id="user-data">
  <thead>
    <tr> 
	  <th scope="span">Bill ID</th>
...
<!--	  <th scope="col">Edit</th>-->
  ...
  <tbody>
    ...
    <tr>
		 ...
		 <td><a href="vieworders_manage.php?delete= <?php echo $row['order_id']; ?> " class="btn btn-danger btn-xs"><i class="fa fa-trash"></a></td>
		 <td><a id= "user-paid" href="vieworders_manage.php?up= <?php echo $row['order_id']; ?> " class="btn btn-success btn-xs"><i class="fa fa-check"></a></td>
