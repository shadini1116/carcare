...
<a  href="myprofile.php">Customer <i class="fa fa-home" aria-hidden="true"></i>
 - <?php echo $name;?></a>
	 ...
	 <a  class="active" href="product2.php">Spare Parts</a>
	 <a   href="product3.php">Electronics</a>
...
$resultSet = $mysqli->query("SELECT * FROM spareparts");  
 							 
	  
if(isset($_POST['submit2']))
{	
$search = $mysqli->real_escape_string($_POST['search']);	
$resultSet = $mysqli->query("SELECT *  FROM spareparts WHERE category = '$search'") ; 
}	 
?>					 						 
...
<th><input type="submit" class="btn btn-primary" value="Search Product" name="submit2" class="form-group"></th>
    ...
    <h2 class="jumbotron">Cabin / Fuel / Air / Oil Filters</h2>
...
?>
    <tr>
		  ...
		  <td>  <h4 class="text-info"> <a href="productdetails2A.php?id=<?php echo $row["id"]; ?>"> <?php echo $row["name"]; ?></a></h4>  </td>
