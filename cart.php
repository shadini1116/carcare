...
<div class="container" style="width:800px;">
    ...
    if(isset($_POST["place_order"]))
    {
        ...
        {
            $order_details .= "  
                          INSERT INTO tbl_order_details(order_id,item_id, product_name, product_category, product_price, product_quantity)  
                          VALUES('".$order_id."','".$values["product_id"]."', '".$values["product_name"]."', '".$values["product_category"]."', '".$values["product_price"]."', '".$values["product_quantity"]."');  
                          ";
        }
	...
	<div class=clearfix>
	<div align="center"><a href="product.php"><button type="button" class="btn btn-success btn btn-lg"> Back To the Store </button></a></div>
		<div align="center"><button onClick="window.print();" class="btn btn-info">Bill</button></div> 
	<br>
