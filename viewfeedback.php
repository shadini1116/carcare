...
?> 
	...
	$result  = $mysqli->query("SELECT * FROM tbl_feedback") or die ($mysqli->erorr);	
...
<li><div align="center"><a class="active" href="viewfeedback.php">Feedbacks</a></div>	</li>
...
<!--
		  ...
		  <div class="section2_admin" style="font-family: 'Gill Sans', 'Gill Sans MT', 'Myriad Pro', 'DejaVu Sans Condensed', Helvetica, Arial, 'sans-serif';font-size: 20px; overflow: scroll">
...
<h1 align="center" class="jumbotron">Feedbacks</h1>
<table class="table table-striped table-hover" id="user-data">
  <thead>
    <tr> 
	  <th scope="span">Feedback ID</th>
...
-->
  ...
  <tbody>
    ...
    <tr>
		 ...
		 <td><a href="feedback_manage.php?delete= <?php echo $row['feedbackID']; ?> " class="btn btn-danger btn-xs"><i class="fa fa-trash"></a></td>
	    </tr>
